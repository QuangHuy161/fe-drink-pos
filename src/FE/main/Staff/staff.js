...
//import { appointments } from '../Staff/demo-data/appointments';
...
export default class Demo extends React.PureComponent {
  ...
  commitDeletedAppointment() {
    this.setState((state) => {
      ...
      const nextData = data.filter(appointment => appointment.id !== deletedAppointmentId);
        ...
        localStorage.setItem('schedule',JSON.stringify(nextData))
  ...
  commitChanges({ added, changed, deleted }) {
    this.setState((state) => {
      ...
      //SAVE
      if(
        JSON.parse(localStorage.getItem('schedule')===undefined )
        ||
